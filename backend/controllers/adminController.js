...
const addDoctor = async (req, res) => {
  try {
    ...
    if (imageFile && imageFile.buffer) {
      const upload = await uploadBufferToCloudinary(imageFile.buffer, 'doclook/doctors');
      imageUrl = upload.secure_url;
    } else {
      // optional: set a default image or return error
      // return res.json({ success:false, message: "Doctor image required" })
      imageUrl = ""; // keep empty if optional
    }
