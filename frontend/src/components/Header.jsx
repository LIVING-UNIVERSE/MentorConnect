        ...
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 '>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-4 m-auto md:py-[10vw] md:mb-[-30px]'>
                <p className='text-2xl md:text-3xl lg:text-4xl text-white font-semibold leading-tight md:leading-tight lg:leading-tight'>
                    Book Appointment <br />  With Trusted Counsellors
                </p>
                <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                    <img className='w-28' src={assets.group_profiles} alt="" />
                    <p>Simply browse through our extensive list of trusted career counsellors, <br className='hidden sm:block' /> schedule your appointment hassle-free.</p>
                </div>
            ...
            <div className='md:w-1/2 relative'>
                {/* <img className=' w-full  md:absolute bottom-0 h-auto rounded-lg' src={assets.header_counseller} alt="" /> */}
                <img className=' w-full  md:absolute bottom-0 rounded-lg' src={assets.header_counseller} alt="" />
            </div>
        </div>
    )
}
